...
const renderProcutsInMujeres = () =>{

    const filtrado = products.filter(product => product.cat );

    console.log(filtrado);

    productsMujeres.innerHTML =filtrado.map(renderCardPruducto).join('');
}
...
const renderPage = () => {
    ...
    renderProcutsInMujeres();
    productsMujeres.addEventListener('click',addCarrito);
